(function() {
  ...
  */
  ...
  brasil.unshift('Para', 'Amazonas', 'Rondonia');
  console.log(brasil);
  ...
  */
  var nordeste = ['Maranhao', 'Piaui', 'Ceara', 'Rio Grande do Norte', 'Pernambuco', 'Paraiba', 'Sergipe', 'Alagoas', 'Bahia'];
  ...
  */
  ...
  brasil.forEach(function(state, i) {
    newBrasil.push({id: i, estado: state});
  })
  ...
  */
  ...
  var moreThan7Letters = brasil.every(function(state) {
  ...
  */
  var map = newBrasil.map(function(state) {
    return {id: state.id + 1, estado: state.estado + ' pertence ao Brasil'}
  })
  ...
  */
  var filter = map.filter(function(state){
    return state.id % 2 == 0;
  });
