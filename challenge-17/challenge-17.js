(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Tuanny Ferreira Ruiz'));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/, function(total) {
  ...
  */
  console.log( '\nReplace de datas:' );
  function replaceDate(regex, d, m, y) {
    return d + '/' + getMonthNumber(m) + '/' + y;
  }
