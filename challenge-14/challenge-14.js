(function() {
  ...
  */
  console.log( '\nOperation:' );
  var operation = justMod2Or3.reduce(function(ac, at) {
    return (ac + 1) * at;
  }, 0);
  ...
  */
  console.log( '\nOperation 2:' );
  var operation2 = justMod2Or3.reduceRight(function(ac, at) {
    return (ac + 1) * at;
  }, 0);
  ...
  */
  ...
  var name = ['Tu', 'an', 'ny'];
  var pLang = name.reduce(function(acc, atual) {
    return acc + 'P' + atual;
  }, '');
  console.log(pLang);
  ...
  */
  console.log( '\nInversed Name:' );
  var inversedName = name.reduceRight(function(ac, at) {
    return ac + at;
  })
